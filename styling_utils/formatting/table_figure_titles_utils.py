...
def apply_table_figure_styles(doc: Document, config, style_attributes_names_mapping, font_mapping, paragraph_format_mapping, style_names_mapping, chapter_section_numbering_regex, renumbering_regex):
    ...
    if table_figure_styles:
        ...
        apply_table_figure_numbering(doc, config, style_names_mapping, style_attributes_names_mapping, chapter_section_numbering_regex, renumbering_regex)


def apply_source_styles(doc: Document, config, style_attributes_names_mapping, font_mapping, paragraph_format_mapping):
...
def apply_table_figure_numbering(doc: Document, config, style_names_mapping, style_attributes_names_mapping, chapter_section_numbering_regex, renumbering_regex):
