...
FONT_MAPPING = {
    ...
    "highlight": ("highlight_color", lambda v: resolve_enum(WD_COLOR_INDEX, v)),
    "color_rgb": ("color.rgb", hex_to_rgbcolor),
}

# Paragraph format attribute mappings
PARAGRAPH_FORMAT_MAPPING = {
    "alignment": ("alignment", lambda v: resolve_enum(WD_ALIGN_PARAGRAPH, v)),
